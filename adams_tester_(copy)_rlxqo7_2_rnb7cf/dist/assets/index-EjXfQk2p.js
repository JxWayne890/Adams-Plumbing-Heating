...
const Navbar = ({ heroRef, whyChooseUsRef, aboutUsRef, servicesRef, contactFormRef }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "bg-white shadow-lg sticky top-0 z-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between h-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex-shrink-0 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary text-xl font-bold", children: "Adams Plumbing & Heating" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center space-x-8", children: [
        location.pathname === "/" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleScroll(heroRef), className: "text-gray-700 hover:text-primary hover:bg-sky-100 px-3 py-2 rounded-md transition-colors", children: "Home" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleScroll(aboutUsRef), className: "text-gray-700 hover:text-primary hover:bg-sky-100 px-3 py-2 rounded-md transition-colors", children: "About" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleScroll(servicesRef), className: "text-gray-700 hover:text-primary hover:bg-sky-100 px-3 py-2 rounded-md transition-colors", children: "Services" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleScroll(contactFormRef), className: "text-gray-700 hover:text-primary hover:bg-sky-100 px-3 py-2 rounded-md transition-colors", children: "Contact" })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/#hero", className: "text-gray-700 hover:text-primary hover:bg-sky-100 px-3 py-2 rounded-md transition-colors", children: "Home" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/#aboutUs", className: "text-gray-700 hover:text-primary hover:bg-sky-100 px-3 py-2 rounded-md transition-colors", children: "About" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/#services", className: "text-gray-700 hover:text-primary hover:bg-sky-100 px-3 py-2 rounded-md transition-colors", children: "Services" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/#contact-form", className: "text-gray-700 hover:text-primary hover:bg-sky-100 px-3 py-2 rounded-md transition-colors", children: "Contact" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/faqs", className: "text-gray-700 hover:text-primary hover:bg-sky-100 px-3 py-2 rounded-md transition-colors", children: "FAQs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+13256776322", className: "bg-primary text-white px-4 py-2 rounded-md hover:bg-primary/90", children: "(325) 677-6322" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsOpen(!isOpen), className: "text-gray-700", children: isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 24 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { size: 24 }) }) })
    ] }) }),
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-2 pt-2 pb-3 space-y-1 sm:px-3", children: [
      location.pathname === "/" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleScroll(heroRef), className: "block px-3 py-2 text-gray-700 hover:text-primary", children: "Home" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleScroll(aboutUsRef), className: "block px-3 py-2 text-gray-700 hover:text-primary", children: "About" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleScroll(servicesRef), className: "block px-3 py-2 text-gray-700 hover:text-primary", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleScroll(contactFormRef), className: "block px-3 py-2 text-gray-700 hover:text-primary", children: "Contact" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/#hero", className: "block px-3 py-2 text-gray-700 hover:text-primary", children: "Home" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/#aboutUs", className: "block px-3 py-2 text-gray-700 hover:text-primary", children: "About" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/#services", className: "block px-3 py-2 text-gray-700 hover:text-primary", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/#contact-form", className: "block px-3 py-2 text-gray-700 hover:text-primary", children: "Contact" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/faqs", className: "block px-3 py-2 text-gray-700 hover:text-primary", children: "FAQs" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+13256776322", className: "block px-3 py-2 text-primary font-bold", children: "(325) 677-6322" })
    ] }) })
  ] });
};
const Footer = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-gray-900 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-4", children: "Adams Plumbing & Heating" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400", children: "Serving Abilene since 1945" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mt-2", children: "License #M-17112" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-4", children: "Contact Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:+13256776322", className: "flex items-center text-gray-400 hover:text-white", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 20, className: "mr-2" }),
            "(325) 677-6322"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "mailto:adamsplumbingheat@att.net", className: "flex items-center text-gray-400 hover:text-white", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 20, className: "mr-2" }),
            "adamsplumbingheat@att.net"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center text-gray-400", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 20, className: "mr-2" }),
            "846 Pine St, Abilene, TX 79601"
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-gray-800 mt-8 pt-8 text-center text-gray-400", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Adams Plumbing & Heating. All rights reserved."
    ] }) })
  ] }) });
};
...
const ContactForm = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "max-w-md mx-auto space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      errors.name && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-sm mt-1", children: (_a2 = errors.name) == null ? void 0 : _a2.message })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "email", className: "block text-sm font-medium text-gray-700", children: "Email" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          type: "email",
      ...
      errors.email && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-sm mt-1", children: (_b2 = errors.email) == null ? void 0 : _b2.message })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "phone", className: "block text-sm font-medium text-gray-700", children: "Phone Number" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          type: "tel",
      ...
      errors.phone && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-sm mt-1", children: (_c2 = errors.phone) == null ? void 0 : _c2.message })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "message", className: "block text-sm font-medium text-gray-700", children: "Message" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Textarea,
        {
          id: "message",
      ...
      errors.message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-500 text-sm mt-1", children: (_d2 = errors.message) == null ? void 0 : _d2.message })
    ] }),
...
const Index = () => {
  ...
  const whyChooseUsRef = reactExports.useRef(null);
  const aboutUsRef = reactExports.useRef(null);
  const servicesRef = reactExports.useRef(null);
  const ctaRef = reactExports.useRef(null);
  const handleContactClick = () => {
    var _a2;
    (_a2 = contactFormRef.current) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-grow", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { ref: heroRef, id: "hero", className: "bg-gradient-to-r from-primary to-blue-900 text-white flex items-center py-20 opacity-0", style: { minHeight: "100svh" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-6xl font-bold mb-6", children: "Your Trusted Plumbing & Heating Experts" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl md:text-2xl mb-8", children: "Serving Abilene Since 1945" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row justify-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "tel:+13256776322", className: "bg-white text-primary px-8 py-3 rounded-md font-bold hover:bg-gray-100 flex items-center justify-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 20, className: "mr-2" }),
            "Call Now"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleContactClick, className: "bg-transparent border-2 border-white text-white px-8 py-3 rounded-md font-bold hover:bg-white hover:text-primary", children: "Contact Us" })
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { ref: whyChooseUsRef, className: "py-16 bg-gray-50 opacity-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-center mb-12", children: "Why Choose Adams Plumbing & Heating?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-12 h-12 mx-auto mb-4 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-2", children: "Licensed & Insured" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "Licensed professionals with verified credentials (License #M-17112)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-12 h-12 mx-auto mb-4 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-2", children: "75+ Years Experience" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "Decades of trusted service in the Abilene community" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-12 h-12 mx-auto mb-4 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-2", children: "A+ BBB Rating" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "Consistently high customer satisfaction ratings" })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { ref: aboutUsRef, id: "aboutUs", className: "py-16 opacity-0 bg-gradient-to-r from-primary to-blue-900 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto flex flex-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl font-bold text-center mb-8", children: [
          "Affordable Plumbing & Heating ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          " Solutions You Can Trust"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-2 flex flex-col md:flex-row justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:w-1/2 md:pr-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-white/70 text-black", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-2xl font-bold mb-4 pb-1 border-b border-white text-white", children: "Who We Are" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-700 mb-4", children: "At Adams Plumbing & Heating, we pride ourselves on being a small, family-owned business with a focus on affordability and quality. With years of experience and a commitment to customer satisfaction, we offer plumbing and heating solutions tailored to your needs." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-700 mb-4", children: "Our low-overhead structure means we can pass significant savings directly to our customers. Unlike larger companies, we’re able to offer competitive pricing without compromising on the quality of our work. Our team is licensed, factory-certified, and ready to handle all your plumbing and heating needs with excellence." })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:w-1/2 md:pl-8 mt-8 md:mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-white/70 text-black", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-2xl font-bold mb-4 pb-1 border-b border-white text-white", children: "Why Choose Us?" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "list-none list-inside text-gray-700 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { className: "h-8 w-8 mr-2 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Up to 40% Lower Pricing" }),
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                  " Our low-overhead model allows us to offer significant savings on major jobs like gas and sewer line services."
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "h-6 w-6 mr-2 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Certified Experts" }),
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                  " Factory-certified to work with trusted brands like Bradford White water heaters."
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-6 w-6 mr-2 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Local & Trusted" }),
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                  " Proudly serving the local community with integrity, reliability, and trust."
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-6 w-6 mr-2 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "No Shortcuts, Just Quality Work" }),
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                  " Every project is handled with professionalism and attention to detail."
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "h-6 w-6 mr-2 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Customer-Focused" }),
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { ref: servicesRef, id: "services", className: "py-16 opacity-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-center mb-12", children: "Our Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-white/70 text-black", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutList, { className: "h-6 w-6" }),
                "Plumbing Services"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "From minor leaks to major installations, we’ve got you covered." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-gray-600", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• General plumbing repairs" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Pipe installations" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Leak detection" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Sewer line services" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Water heater installation and repair" })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-white/70 text-black", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "h-6 w-6" }),
                "Heating Services"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "We handle heating projects of all sizes, keeping your home warm and energy-efficient year-round." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-gray-600", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Heating system installation" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Preventive maintenance" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Repair services" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• System upgrades" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "• Emergency heating repairs" })
            ] }) })
          ] })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact-form", className: "py-16", ref: contactFormRef, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-center mb-12", children: "Contact Us" }),
...
const Faqs = () => {
  ...
  const [contentHeight, setContentHeight] = reactExports.useState(null);
  ...
  reactExports.useRef(null);
  reactExports.useRef(null);
  const ctaButtonRef = reactExports.useRef(null);
  const [isCtaVisible, setIsCtaVisible] = reactExports.useState(false);
  const faqs = {
    General: [
      {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-grow py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-1/4 pr-8 border-r", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-6", children: "Categories" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: Object.keys(faqs).map((category) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl font-bold mb-6", children: [
              activeCategory,
              " FAQs"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "list-none list-inside text-gray-700 space-y-4", children: (_a2 = faqs[activeCategory]) == null ? void 0 : _a2.map((faq, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold", children: faq.question }),
...
const App = () => /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TooltipProvider, { children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/faqs", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Faqs, {}) })
  ] }) }),
